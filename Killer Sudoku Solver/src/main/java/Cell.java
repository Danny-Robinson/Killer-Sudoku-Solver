...
public class Cell {
	...
	public void setCommittedVal(int committedVal, Grid g) {
		if (committedVal > 0 && committedVal < 10 && !this.isCommitted()){	
			...
			this.getBox().setSumVal(this.getBox().getSumVal() - committedVal);
			this.getRow().setSumVal(this.getRow().getSumVal() - committedVal);
			this.getColumn().setSumVal(this.getColumn().getSumVal() - committedVal);
