			...
			for (Cage cage: box.getCageList()){
				...
				if (inc == cage.getCageSize()){
					switch (cage.getCageSize()){
						...
						case 3:
							if (cage.getCell(0).getPossibleVals().equals(cage.getCell(1).getPossibleVals())
									&& cage.getCell(1).getPossibleVals().equals(cage.getCell(2).getPossibleVals())
										&& cage.getCell(0).getPossibleVals().size() == 3){
									for (Integer poss: cage.getCell(0).getPossibleVals()){
										for (Cell cell: box.getCellList()){
											if (  !(cell.equals(cage.getCellList().get(0)) || cell.equals(cage.getCellList().get(1))) 
													&& !cell.equals(cage.getCellList().get(2))  ){
												System.out.println("Cage  size 3 box exclusion: " + cell.getCoord());
												cell.removePossibleVal(poss);
											}	
										}
									}
						...
						case 4:
							if (cage.getCell(0).getPossibleVals().equals(cage.getCell(1).getPossibleVals())
									&& cage.getCell(1).getPossibleVals().equals(cage.getCell(2).getPossibleVals())
										&& cage.getCell(2).getPossibleVals().equals(cage.getCell(3).getPossibleVals())
											&& cage.getCell(0).getPossibleVals().size() == 4){
									for (Integer poss: cage.getCell(0).getPossibleVals()){
										for (Cell cell: box.getCellList()){
											if (  !(cell.equals(cage.getCellList().get(0)) || cell.equals(cage.getCellList().get(1))) 
													&& !(cell.equals(cage.getCellList().get(2)) || cell.equals(cage.getCellList().get(4)))  ){
												System.out.println("Cage size 4 box exclusion: " + cell.getCoord());
												cell.removePossibleVal(poss);
											}	
										}
									}
							...
							if (cage.getCell(0).getPossibleVals().equals(cage.getCell(1).getPossibleVals())
									...
									for (Integer poss: cage.getCell(0).getPossibleVals()){
										for (Cell cell: col.getCellList()){
											if (  !(cell.equals(cage.getCellList().get(0)) || cell.equals(cage.getCellList().get(1))) 
													&& !cell.equals(cage.getCellList().get(2))  ){
												System.out.println("Cage  size 3 col exclusion: " + cell.getCoord());
												cell.removePossibleVal(poss);
											}	
										}
									}
							...
							if (cage.getCell(0).getPossibleVals().equals(cage.getCell(1).getPossibleVals())
									...
									for (Integer poss: cage.getCell(0).getPossibleVals()){
										for (Cell cell: row.getCellList()){
											if (  !(cell.equals(cage.getCellList().get(0)) || cell.equals(cage.getCellList().get(1))) 
													&& !cell.equals(cage.getCellList().get(2))  ){
												System.out.println("Cage  size 3 row exclusion: " + cell.getCoord());
												cell.removePossibleVal(poss);
											}	
										}
									}
